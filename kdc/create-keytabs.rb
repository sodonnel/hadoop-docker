...
#kadmin -p root/admin -w password -q "delprinc -force hdfs/$(hostname)"  
#kadmin -p root/admin -w password -q "addprinc -randkey hdfs/$(hostname)"
#kadmin -p root/admin -w password -q "xst -k ./hdfs-unmerged.keytab hdfs/$(hostname)"
#echo -e "rkt hdfs-unmerged.keytab\nwkt hdfs.keytab\nquit" | ktutil
...
def remove_princ(princ)
  system("kadmin -p root/admin -w password -q \"delprinc -force #{princ}/$(hostname)\"")
end
...
def merge_into_target(princ, target)
  ...
  system("echo -e \"rkt #{princ}.tmp.keytab\nwkt #{target}\nquit\" | ktutil")
  # delete #{princ}.tmp.keytab
end
